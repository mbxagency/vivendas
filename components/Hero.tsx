        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center space-x-4 mb-4">
              <span className="text-3xl font-bold text-red-400 line-through">{siteConfig.property.originalPrice}</span>
              <span className="text-5xl font-bold text-green-400">{siteConfig.property.price}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 max-w-2xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              <h3 className="text-2xl font-bold mb-2 text-green-400">{siteConfig.property.area}</h3>
              <p className="text-gray-200">Área do Terreno</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              <h3 className="text-2xl font-bold mb-2 text-blue-400">{siteConfig.property.location.split(',')[0]}</h3>
              <p className="text-gray-200">Bairro Exclusivo</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8 max-w-2xl mx-auto">
            <button 
              ...
              className="bg-green-600 hover:bg-green-700 text-white font-bold text-lg px-8 py-4 rounded-lg transition-colors duration-200 flex items-center justify-center min-w-[200px] h-[60px]"
            ...
            <button 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg px-8 py-4 rounded-lg transition-colors duration-200 flex items-center justify-center min-w-[200px] h-[60px]"
              data-contact="phone"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-phone w-6 h-6 mr-2">
