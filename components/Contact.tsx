  ...
  return (
    <section id="contact" className="section-padding bg-gray-900 text-white">
      <div className="container-custom">
        ...
        {/* Price Highlight */}
        <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-2xl p-6 mb-8 text-center max-w-2xl mx-auto">
          <div className="flex items-center justify-center space-x-6 mb-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-red-300 line-through">{siteConfig.property.originalPrice}</div>
              <div className="text-xs text-gray-200">De</div>
            </div>
            <div className="text-4xl font-bold text-white">{siteConfig.property.price}</div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-300">-{siteConfig.property.discount}</div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
            ...
            <div className="text-center mb-8">
              <button
                ...
                className="bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-8 rounded-lg transition-colors duration-200 flex items-center justify-center mx-auto text-lg min-w-[200px] h-[60px]"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="flex items-center p-6 bg-white/5 rounded-lg hover:bg-white/10 transition-colors duration-200 cursor-pointer h-24" onClick={openPhone}>
              ...
              <div className="flex items-center p-6 bg-white/5 rounded-lg hover:bg-white/10 transition-colors duration-200 cursor-pointer h-24" onClick={openEmail}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
              <div className="bg-white/5 rounded-lg p-6 h-32 flex flex-col justify-center">
                <div className="text-2xl font-bold text-green-400 mb-2">{siteConfig.property.area}</div>
                <div className="text-gray-300">Área do Terreno</div>
              </div>
              <div className="bg-white/5 rounded-lg p-6 h-32 flex flex-col justify-center">
                <div className="text-2xl font-bold text-blue-400 mb-2">{siteConfig.location.neighborhood}</div>
                <div className="text-gray-300">Localização</div>
              </div>
              <div className="bg-white/5 rounded-lg p-6 h-32 flex flex-col justify-center">
                <div className="text-2xl font-bold text-yellow-400 mb-2">{siteConfig.property.price}</div>
